...
const fallbackUpdates = [
  {
    ...
    date: "2026.08.13",
    title: "채널 관리 기능이 개선됐어요",
    items: [
      "채널 가입 신청은 채널 소유자·관리자가 현재 채널별로 승인할 수 있습니다.",
      "채널 사용자 관리에서 승인된 사용자를 확인하고 채널에서 추방할 수 있습니다.",
      "추방 대상이 진행 중인 빙고방의 방장이라도 해당 방을 자동 종료한 뒤 채널에서 추방됩니다.",
      "개발자는 어느 주요 페이지에서든 채널 생성과 채널 생성 신청을 확인할 수 있습니다.",
      "채널을 만들 때 빙고와 킬내기 중 사용할 기능을 선택할 수 있으며 두 기능을 모두 선택할 수도 있습니다.",
      "개발자는 채널에 들어간 뒤 채널 기능 설정에서 빙고·킬내기 사용 여부를 다시 변경할 수 있습니다."
    ],
    published: true,
    fallback: true
  },
